...
[_QWERTY] = LAYOUT(
  ...
  KC_LSFT,  KC_Z,   KC_X,    KC_C,    KC_V,    KC_B,            QK_BOOT,   KC_PEQL, KC_N,    KC_M,    KC_COMM, KC_DOT, KC_SLSH,  KC_RSFT,
                    KC_LCTL, KC_LALT, KC_UNDS, LT(_SYMBOLS, KC_ENTER), KC_UP,     KC_DOWN, LT(_KARABINER, KC_SPC),  KC_BSPC, KC_LEFT, KC_RIGHT
),
...
[_SYMBOLS] = LAYOUT(
  ...
  KC_RGHT,  KC_COMMA,       KC_ASTERISK,    KC_MS_BTN1,    LGUI(KC_V),    KC_BACKSPACE, KC_MUTE,    XXXXXXX, KC_EXCLAIM,         KC_LCBR,       KC_RCBR,           KC_DOT,        KC_SLSH,              KC_COLON,
                                                KC_SPACE,KC_SPACE, KC_SPACE, KC_SPACE, KC_SPACE,    KC_BSPC, KC_SPACE, KC_SPACE, KC_SPACE,      KC_SPACE
),

[_KARABINER] = LAYOUT(
   KC_TILDE, KC_EXCLAIM,     KC_AT,          KC_HASH,       KC_DOLLAR,     KC_PERCENT,                       KC_CIRCUMFLEX,     KC_AMPERSAND,  KC_END,       KC_LEFT_PAREN,  KC_HOME,        KC_BACKSPACE,
   KC_TAB,   KC_QUOTE,       KC_EQUAL,       C(KC_E),      KC_ENTER,      KC_TILDE,                         KC_QUESTION,       KC_LEFT_PAREN, C(KC_I),    KC_PIPE,        KC_PLUS,               GUI_T(KC_BACKSLASH),
   KC_LEFT,  KC_AMPERSAND,   KC_LSFT,        KC_MINUS,      KC_UNDS,       KC_END,                          KC_LEFT,           KC_DOWN,       KC_UP,           KC_RIGHT,        KC_COLON,              KC_DQUO,
   KC_RGHT,  KC_COMMA,       KC_ASTERISK,    C(KC_C),       C(KC_V),       KC_BACKSPACE, KC_MUTE,    XXXXXXX,KC_EXCLAIM,        KC_LCBR,       KC_RCBR,           KC_RABK,        KC_UP,              KC_COLON,
                                                KC_SPACE,KC_SPACE, KC_SPACE, KC_SPACE, KC_SPACE,    KC_BSPC,  KC_SPACE, KC_SPACE, KC_SPACE, KC_SPACE
)
/* /\* */
/*  * COLEMAK */
