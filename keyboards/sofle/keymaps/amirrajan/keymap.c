...
[_KARABINER] = LAYOUT(
   ...
   KC_TAB,   KC_QUOTE,       KC_EQUAL,       KC_EQUAL,      KC_ENTER,      KC_TILDE,                         KC_QUESTION,       KC_LEFT_PAREN, KC_RIGHT_PAREN,    KC_PIPE,        KC_PLUS,               GUI_T(KC_BACKSLASH),
   KC_LEFT,  KC_AMPERSAND,   KC_HOME,        KC_MINUS,      KC_UNDS,       KC_END,                          KC_LEFT,           KC_DOWN,       KC_UP,           KC_RIGHT,        KC_COLON,              KC_DQUO,
   KC_RGHT,  KC_COMMA,       KC_ASTERISK,    KC_MS_BTN1,    KC_LSFT,       KC_BACKSPACE, KC_MUTE,    XXXXXXX,KC_EXCLAIM,        KC_LCBR,       KC_RCBR,           KC_RABK,        KC_UP,              KC_COLON,
                                                KC_SPACE,KC_SPACE, KC_SPACE, KC_SPACE, KC_SPACE,    KC_BSPC,  KC_SPACE, KC_SPACE, KC_SPACE, KC_SPACE
)
/* /\* */
/*  * COLEMAK */
