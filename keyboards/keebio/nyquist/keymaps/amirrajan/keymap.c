...
[_BASE] = LAYOUT( \
 ...
 KC_LCTL,       KC_A,           KC_S,             KC_D,           KC_F,           KC_G,                   KC_H,          KC_J,        KC_K,       KC_L,          KC_SCOLON,    RCTL_T(KC_QUOTE),                            \
...
[_SYMBOLS] = LAYOUT( \
 ...
 KC_RGHT,       KC_COMMA,       KC_ASTERISK,      KC_COMMA,       RGB_HUI,        MACRO_PARENS,          KC_EXCLAIM,    KC_LCBR,          KC_RCBR,        KC_RABK,        KC_QUESTION,     KC_0,                            \
