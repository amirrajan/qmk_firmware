...
[_QWERTY] = LAYOUT_ortho_5x12(
 ...
 KC_LCTL,       KC_A,           KC_S,             KC_D,           KC_F,           KC_G,                   KC_H,            KC_J,           KC_K,            KC_L,           KC_SEMICOLON,    RCTL_T(KC_QUOTE),    \
 KC_LSFT,       KC_Z,           KC_X,             KC_C,           KC_V,           KC_B,                   KC_N,            KC_M,           KC_COMMA,        KC_DOT,         KC_SLASH,        KC_RSFT,             \
 KC_LCTL,       KC_LALT,        KC_LCMD,          KC_EQUAL,       KC_UNDS,        LT(1, KC_ENTER),        LT(2, KC_SPACE), KC_BSPC,        KC_LEFT,         KC_DOWN,        KC_UP,           KC_RGHT \
),
