...
[_SYMBOLS] = LAYOUT_ortho_5x12(
 ...
 KC_RGHT,       KC_COMMA,       KC_ASTERISK,      KC_COMMA,       LGUI(KC_V),     KC_BACKSPACE,          KC_EXCLAIM,       KC_LCBR,        KC_RCBR,         KC_RABK,        KC_MS_U,         KC_0,                \
 KC_DOWN,       KC_LALT,        KC_LCMD,          KC_MS_BTN2,     KC_MS_BTN1,     KC_SPACE,              KC_SPACE,         KC_BSPC,        KC_MS_BTN1,      KC_MS_L,        KC_MS_D,         KC_MS_R              \
),
